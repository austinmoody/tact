...
def downgrade() -> None:
    """Downgrade schema."""
    op.add_column('time_codes', sa.Column('description', sa.Text(), nullable=False, server_default=''))
    op.add_column('time_codes', sa.Column('keywords', sa.Text(), nullable=True, server_default='[]'))
    op.add_column('time_codes', sa.Column('examples', sa.Text(), nullable=True, server_default='[]'))
